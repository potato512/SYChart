...
@interface LYSChartCurveLineVC ()

@end

@implementation LYSChartCurveLineVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.title = @"LYSChartCurveLine";
    [self setUI];
}
...
//    chartView1.valueData = @[@"0.648",@"0.240",@"0.144",@"0.540",@"0.849",@"0.0",@"0.0",@"0.251",@"0.135",@"0.0",@"0.413",@"0.592",@"0.521",@"0.111"];
    ...
    chartView1.row = chartView1.valueData.count;
    chartView1.column = chartView1.valueData.count;
