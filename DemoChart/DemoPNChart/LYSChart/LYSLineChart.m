...
- (CGFloat)rowSpace{
    if (_rowSpace == 0) {
        ...
        NSLog(@"_canvasEdgeInsets = %@, _size = %@", NSStringFromUIEdgeInsets(_canvasEdgeInsets), NSStringFromCGSize(_size));
        NSLog(@"CanvasLeftTopPoint = %@, CanvasLeftBottomPoint = %@, TwoPointSpacing = %@", NSStringFromCGPoint(CanvasLeftTopPoint), NSStringFromCGPoint(CanvasLeftBottomPoint), @(TwoPointSpacing(CanvasLeftTopPoint, CanvasLeftBottomPoint)));
    }
    return _rowSpace;
}
- (CGFloat)columnSpace{
