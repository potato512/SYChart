...
@interface AAChartPieVC ()

@property (nonatomic, strong) UIChartView *chartView;

@end

@implementation AAChartPieVC
...
- (void)viewDidLoad {
    ...
    */
    ...
    self.chartView.chartModel.chartTypeSet(AAChartTypePie); // 类型
...
//    self.chartView.chartXTitles = @[@"Java", @"Swift", @"Python", @"Objective-C", @"PHP", @"Go"];
    ...
    model.name = @"语言热度占比";
    model.datas = @[@[@"Java", @67], @[@"Swift", @44], @[@"Python", @83], @[@"Objective", @11], @[@"PHP", @42], @[@"Go", @63]];
