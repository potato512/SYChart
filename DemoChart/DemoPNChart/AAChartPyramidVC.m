...
@interface AAChartPyramidVC ()

@property (nonatomic, strong) UIChartView *chartView;

@end

@implementation AAChartPyramidVC
...
- (void)viewDidLoad {
    ...
    */
    ...
    self.chartView.chartModel.chartTypeSet(AAChartTypePyramid); // 类型
...
//    self.chartView.chartXTitles = @[@"Java", @"Swift", @"Python", @"Objective-C", @"PHP", @"Go"];
    ...
    model.name = @"2020";
    model.datas = @[@[@"Java", @15054], @[@"Swift", @15654], @[@"Python", @846], @[@"Objective-C", @4064], @[@"PHP", @1987], @[@"GO", @976]];
